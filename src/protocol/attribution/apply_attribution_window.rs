...
/// Creates a vector of tuples. The left elements are trigger values where values are
/// set to `0` if the time delta from their nearest source event exceed the specified
/// attribution window cap. Each of the right elements is shares of {0, 1} indicating
