...
pub async fn aggregate_credit<F, BK, G>(
...
/// # Errors
/// propagates errors from multiplications
pub async fn malicious_aggregate_credit<'a, F, BK, G>(
...
async fn simple_aggregate_credit<F, C, T, G, BK>(
    ctx: C,
...
fn add_aggregation_bits_and_breakdown_keys<F, C, T, G, BK>(
    ctx: &C,
    capped_credits: impl Iterator<Item = MCAggregateCreditInputRow<F, T>>,
    max_breakdown_key: u32,
